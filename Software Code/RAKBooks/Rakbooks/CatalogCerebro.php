...
if (isset($_POST['addtocart'])) 
{
    ...
    $book_name = $_POST['book_name']; // Book title
    $price = $_POST['price'];
...
// Path to Cerebro WSDL
$wsdl = "http://localhost/RAKBooks/Cerebro/service.wsdl";
...
try 
{
    ...
    // Request books using supplierID = Cerebro
    $response = $client->getBooks(['supplierID' => 'Cerebro']); 
...
<body>
    ...
    <div class="top-nav">
        ...
        <div class="right-nav">
            ...
            <form method="GET" action="CatalogCerebro.php">
        ...
        <?php if (!empty($books)): ?>
            ...
            <?php foreach($books as $b): ?>
                <div class="book-card">
                    ...
                    =========================== -->
                    <form action="CatalogCerebro.php" method="POST">
