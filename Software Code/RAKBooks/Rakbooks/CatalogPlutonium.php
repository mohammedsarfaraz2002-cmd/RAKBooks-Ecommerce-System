...
// Path to Plutonium WSDL
$wsdl = "http://localhost/RAKBooks/Plutonium/service.wsdl";
...
try 
{
    ...
    // Request books using supplierID = Plutonium
    $response = $client->getBooks(['supplierID' => 'Plutonium']); 
...
<body>
    ...
    <div class="top-nav">
        ...
        <div class="right-nav">
            ...
            <form method="GET" action="CatalogPlutonium.php">
        ...
        <?php if (!empty($books)): ?>
            ...
            <?php foreach($books as $b): ?>
                <div class="book-card">
                    ...
                    =========================== -->
                    <form action="CatalogPlutonium.php" method="POST">
